...
class PersonValidator {
    static checkCpfAlreadyInUse(personsPhysical, cpf) {
        if (personsPhysical.some((person) => person.cpf === cpf)) {
    ...
    static checkCnpjAlreadyInUse(personsLegal, cnpj) {
        if (personsLegal.some((person) => person.cnpj === cnpj)) {
